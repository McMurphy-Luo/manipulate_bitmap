...
public:
  ...
  signals::signal<void(int, std::string&)> sig_1;
  signals::signal<void(int, std::string&)> sig_2;
};
...
void TestSignalAsClassMember() {
  ...
  std::string output;
  signal_class_object_1->sig_1.operator()<int, std::string&>(100, output);
